    ...
    <>
      <Dialog open={isOpen ?? false} onClose={() => setIsOpen(false)}>
        <div className={styles.div_modal}>
          <DialogPanel className="absolute top-2 w-[364px] px-4 py-6 bg-[var(--cor-fundo)] border-1 border-[var(--cor-principal)] rounded-[10px] inline-flex flex-col justify-center items-center gap-6">
            ...
            <div className="w-full flex flex-col gap-2.5">
              <div className="flex flex-col gap-1">
                ...
                <input type="text" name="email" id="email" placeholder="Nome do usuário/e-mail" />
              </div>
            ...
            <div className="w-full flex flex-col items-center gap-3">
              <input type="submit" value="Entrar" className="button-primary button-form-submit" />
